...
preload("res://scenes/puzzles/shift_puzzle_3d.tscn"), preload("res://scenes/puzzles/Operation3D.tscn")]


var puzzle_scales = [0.45,0.4,0.5,0.5,0.4,0.35,0.2,0.6,0.08,0.17,0.2,0.2,0.25,.00075]
var puzzle_weights = [2,4,3,4,2,2,1,3,2,4,3,3,8,1] #Value of how hard/time-consuming each puzzle is, will eventually be used to determine what puzzles you get
var weights_left =   [2,4,3,3,2,2,1,3,2,4,3,3,8,1]
