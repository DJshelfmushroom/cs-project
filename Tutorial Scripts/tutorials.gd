...
func _on_puzzle_2_tutorial_button_up() -> void:
	get_tree().change_scene_to_file("res://puzzle_2_tutorial.tscn")
	#SceneManager.ChangeScene(self, "res://puzzle_2_tutorial.tscn")


func _on_puzzle_3_tutorial_button_up() -> void:
	get_tree().change_scene_to_file("res://puzzle_3_tutorial.tscn")
